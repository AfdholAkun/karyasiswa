	...
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading" >
				<span style="font-size: 11pt">Data Kota
				</span>
			</div>
			...
			<form action="#" id="form" class="form-horizontal">
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" name="kode" class="form-control" required maxlength="10" onkeyup="CekKodeKota()">
...
var SaveMethod = "Tambah";
	...
	$(document).ready(function() {
		$('#form').on("submit", function(e){
			...
			if (SaveMethod == "Tambah") {
				url = link+'kota/InsertData';
			}else{
				url = link+'kota/UpdateData';
			}
	...
	function CekKodeKota() {
		delay(function(){
			$.ajax({
				url: link+'kota/CekKodeKota',
				type: 'post',
				...
				error: function(){
					notify("Error System", "Gagal Cek Kode Kota", "error");
				}
			});
		}, 300);
	}
	...
	function ResetData() {
		...
		if (row > 1) {
			swal({
				title: "Reset data ?",
				text: "Menghapus semua data kota ",
				type: "warning",
				showCancelButton: true,
				confirmButtonClass: "btn-warning",
				confirmButtonText: "Ok",
