...
class Model_negara extends CI_Model {

	var $table = 'negara';
	var $column_order = array(null, 'kode','nama_negara',null);
	var $column_search = array('kode','nama_negara');
	var $where = "is_deleted = 0";
	var $order_default = "nama_negara desc";
