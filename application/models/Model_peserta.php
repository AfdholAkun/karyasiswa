...
class Model_peserta extends CI_Model {
	...
	var $table = 'v_peserta';
	var $column_order = array(null, 'nip','nama', 'jenis_kelamin', 'tempat_lahir', null);
	var $column_search = array('nip', 'nama', 'jenis_kelamin', 'tempat_lahir', 'tgl_lahir');
	var $where = "is_deleted = 0";
	var $order_default = "nama desc";
