...
class Model_user extends CI_Model {
	...
	var $table = 'user';
	var $column_order = array(null, 'kode_user', 'name_user', 'email', 'level', 'status', null);
	var $column_search = array('kode_user', 'name_user', 'email', 'level', 'status');
	var $where = "is_deleted = 0";
	var $order_default = "kode_user asc";
